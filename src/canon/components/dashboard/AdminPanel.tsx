// Arquivo removido. AdminPanel do Dashboard não é mais usado.
import { useState, useEffect } from "react";
import { supabase } from "@canon/integrations/supabase/client";
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from "recharts";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@canon/components/ui/select";
